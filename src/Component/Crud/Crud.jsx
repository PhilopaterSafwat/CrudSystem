...
export default function Crud() {
    ...
    const fetchProducts = async () => {
        try {
            const response = await axios.get("http://crudsystemapp.eu-4.evennode.com/product/", {
                headers: {
    ...
    const fetctAddProducts = async (product) => {
        try {
            const response = await axios.post("http://crudsystemapp.eu-4.evennode.com/product/add", product, {
                headers: {
                    "Authorization": JSON.parse(localStorage.getItem("Authentication"))
                }
            });
    ...
    const fetctUpdateProducts = async (id, productQuantity, productName, price, category, attachment) => {
        ...
        try {
            const { data } = await axios.patch(`http://crudsystemapp.eu-4.evennode.com/product/update/${id}`, formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://crudsystemapp.eu-4.evennode.com/product/delete/${id}`, {
                headers: {
                    "Authorization": JSON.parse(localStorage.getItem("Authentication"))
                }
            })
